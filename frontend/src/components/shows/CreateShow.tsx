...
export default function CreateShow({
  ...
  const form = useForm<Show>({
    ...
    defaultValues: {
      ...
      economySeatTo: undefined,
      economySeatPrice: undefined,
      premiumSeatPrice: undefined,
      premiumSeatTo: undefined,
      reclinerSeatPrice: undefined,
      reclinerSeatTo: undefined,
    },
  });
  ...
  const submit = async (data: ShowType) => {
    try {
      ...
      await createShow(data, theaterId);
